                        ...
                        try {
                            if(connection != null || try2Connect()){
                                ...
                                if(Environment.needDebug){
                                    ...
                                    //Environment.toastInHandler(adbHelper.context, "tvremoteplay成功向adb服务发送命令。"  + msg);
                                }
                            }else {
                                if(Environment.needDebug){
                                    Environment.debug(TAG, "未发送adb命令：" + msg);
                                    //Environment.toastInHandler(adbHelper.context, "tvremoteplay向adb服务发送命令时失败。");
                                }
                            }
                            //stream.close();
                        } catch (Exception e) {
                            if(Environment.needDebug){
                                ...
                                //Environment.toastInHandler(adbHelper.context, "tvremoteplay向adb服务发送命令时出错。" + e.toString());
                            }
                        }
                    }
                }
