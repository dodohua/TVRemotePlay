package com.android.tvremoteplay.server;
...
import com.android.tvremoteplay.IMEService;
...
public class RemoteServerFileManager implements NanoHTTPD.TempFileManager {
    static File baseDir = new File(Environment.getExternalStorageDirectory(), "tvremoteplay");
